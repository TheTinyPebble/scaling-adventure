...
exampleVendorConvoTemplate = VendorConvoTemplate:new {
	luaClassHandler = "ExampleVendorConvoHandler"
}

addConversationTemplate("exampleVendorConvoTemplate", exampleVendorConvoTemplate);